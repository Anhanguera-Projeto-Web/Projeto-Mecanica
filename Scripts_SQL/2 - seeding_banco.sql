...
CALL sp_criar_produto("Assento", 0, 0, 20.99);
CALL sp_criar_produto("Cavalete Carro Automotivo", 0, 0, 20.99); 
CALL sp_criar_produto("Borboleta", 0, 0, 20.99); 
CALL sp_criar_produto("Burrinho", 0, 0, 20.99); 
CALL sp_criar_produto("Freio", 0, 0, 20.99); 
CALL sp_criar_produto("Macaco", 0, 0, 20.99); 
CALL sp_criar_produto("Pistãocaco", 0, 0, 20.99); 
CALL sp_criar_produto("Caixa de câmbio", 0, 0, 20.99);
CALL sp_criar_produto("Suspensão", 0, 0, 20.99); 
CALL sp_criar_produto("Pinhão impulsor de partida", 0, 0, 20.99); 
CALL sp_criar_produto("Pinça de Freio", 0, 0, 20.99); 
CALL sp_criar_produto("Escapamento", 0, 0, 20.99); 
CALL sp_criar_produto("Lâmpada Super LED Headlight HB3", 0, 0, 55.01); 
CALL sp_criar_produto("Filtro Combustível Injeção Civic", 0, 0, 55.01); 
CALL sp_criar_produto("Som Automotivo com Bluetooth Rádio", 0, 0, 55.01); 
CALL sp_criar_produto("Bomba de Combustível Belina e Corcel", 0, 0, 55.01); 
CALL sp_criar_produto("Terminal Direção", 0, 0, 55.01); 
CALL sp_criar_produto("Mangueira Retorno Radiador", 0, 0, 55.01); 
CALL sp_criar_produto("Eletroventiladores Citroen C3", 0, 0, 55.01);
CALL sp_criar_produto("Agulha Carburador", 0, 0, 55.01); 
CALL sp_criar_produto("Conjunto Cápsula Vácuo Marcha", 0, 0, 55.01);
CALL sp_criar_produto("Sensor Detonação Xantia", 0, 0, 55.01); 
CALL sp_criar_produto("Sensor de Velocidade Passat", 0, 0, 55.01); 
CALL sp_criar_produto("Diafragma Monoponto", 0, 0, 55.01); 